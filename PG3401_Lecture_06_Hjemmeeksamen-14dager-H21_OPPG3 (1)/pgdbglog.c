/* PGDBGLOG.C header file ---------------------------------------------------------------------
 ...
 Description : Source file for the "PG Debug Logger" system, this file and the corresponding
               header file could also be placed in a library project, but I have decided to
...
int glob_bTraceEnabled = 0; // Defined as extern in pgdbglog.h, on some compilers this can give us trouble if we also include it above
